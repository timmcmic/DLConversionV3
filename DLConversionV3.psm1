...
Function Start-DistributionListMigrationV3 
{
    ...
    *Required*
    ...
    if (($testRecipientHealth -eq $TRUE) -or ($testPropertyHealth -eq $TRUE) -or ($testDLConversionV2 -eq $TRUE))
    {
    ...
    {
        out-logfile -string "All normalization and health checking was skipped due to migration request."
    }
